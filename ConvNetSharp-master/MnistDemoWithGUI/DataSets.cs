...
namespace MnistDemoWithGUI
{
    internal class DataSets
    {
        ...
        public MessageDelegate MessageHolder;
        ...
        private void DownloadFile(string urlFile, string destFilepath)
        {
            if (!File.Exists(destFilepath))
            {
                ...
                catch (Exception e)
                {
                    ...
                    MessageBox.Show("Failed downloading " + urlFile + "\n" + e.Message);
                }
            }
        }
        ...
        public bool Load(int validationSize = 1000)
        {
            ...
            MessageHolder(" Downloading Mnist training files ...");
            ...
            MessageHolder(" Downloading Mnist testing files ...");
            ...
            MessageHolder(" Loading the datasets ...");
            ...
            if (train_images.Count == 0 || valiation_images.Count == 0 || testing_images.Count == 0)
            {
                ...
                //Console.ReadKey();
                MessageBox.Show("Missing Mnist training/testing files.");
                return false;
            }
